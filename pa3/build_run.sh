export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/home/user/pa3";
export LD_PRELOAD="/home/user/pa3/libruntime.so";
...
LD_PRELOAD=/home/user/pa3/libruntime.so ./pa2 -p $count $my_program
